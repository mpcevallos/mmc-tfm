            ...
            <div className="card mb-3" style={{ maxWidth: "400px" }}>
              <div className="row g-0">
                <div className="col-md-4 gradient-background rounded">
                  <img
                    src="https://res.cloudinary.com/cloudpaudev/image/upload/v1725838424/doctor1_mmc.png"
          ...
          <div className="col md-6" style={{ width: "600px" }}>
            <div className="card mb-3" style={{ maxWidth: "400px" }}>
              <div className="row g-0">
                ...
                >
                  <img
                    src="https://res.cloudinary.com/cloudpaudev/image/upload/v1725838471/doctores-grupo_mmc.jpg"
                    className="img-fluid rounded-start p-3 mt-5"
          ...
          <div className="col">
            <div className="card mb-3" style={{ maxWidth: "600px" }}>
              <div className="row g-0">
                <div className="col-md-4 gradient-background rounded">
                  <img
                    src="https://res.cloudinary.com/cloudpaudev/image/upload/v1725838423/doctor3_mmc.png"
                    className="img-fluid rounded-start p-3 mt-5"
